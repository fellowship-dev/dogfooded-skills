...
| [`ops/search-and-rerank`](skills/ops/search-and-rerank/) | Experimental query-specific retrieval, bounded reranking and conversational feedback; host integration required, production gains unmeasured |
